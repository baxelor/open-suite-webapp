...
public class PurchaseOrder extends AuditableModel {
	...
	public Boolean getIsPurchaseParent() {
		return isPurchaseParent == null ? Boolean.FALSE : isPurchaseParent;
	}
